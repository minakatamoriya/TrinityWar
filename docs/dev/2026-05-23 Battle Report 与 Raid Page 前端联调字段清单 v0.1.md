...
1. 接口契约：[dev/2026-05-18 首批真实接口契约清单 v0.1.md](dev/2026-05-18 首批真实接口契约清单 v0.1.md)
2. 读接口切换计划：[dev/2026-05-18 首批读接口联调切换计划 v0.1.md](dev/2026-05-18 首批读接口联调切换计划 v0.1.md)
3. 掠夺订单与异步结算：[dev/2026-05-23 掠夺订单与异步结算专项设计 v0.1.md](dev/2026-05-23 掠夺订单与异步结算专项设计 v0.1.md)
...
你现在只负责把 `ClientRaidTarget[]` 对接到真实数据库读取链路。请严格按 [dev/2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md](dev/2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md) 的字段清单提供首批必要字段。不要顺手改 report list。
