...
1. Prisma/schema 规划：[dev/TrinityWar 首批数据库表与 Prisma Schema 草案 v0.1.md](dev/TrinityWar 首批数据库表与 Prisma Schema 草案 v0.1.md)
2. Migration 切分计划：[dev/TrinityWar 首批数据库 Migration 切分计划 v0.1.md](dev/TrinityWar 首批数据库 Migration 切分计划 v0.1.md)
3. 读接口切换计划：[dev/TrinityWar 首批读接口联调切换计划 v0.1.md](dev/TrinityWar 首批读接口联调切换计划 v0.1.md)
4. 前端 mock 退场计划：[dev/TrinityWar 前端 Mock 数据退场计划 v0.1.md](dev/TrinityWar 前端 Mock 数据退场计划 v0.1.md)
5. 农场设计主文档：[docs/design/Trinity War 首发农场与金币曲线首稿 v0.1.md](docs/design/Trinity War 首发农场与金币曲线首稿 v0.1.md)
...
建议优先从 [docs/design/Trinity War 首发农场与金币曲线首稿 v0.1.md](docs/design/Trinity War 首发农场与金币曲线首稿 v0.1.md) 的首发种子表整理，而不是继续直接抄 [apps/game-client/src/api.ts](apps/game-client/src/api.ts) 里的临时常量。
...
2. 再让真实接口把种子相关字段吐给前端。
3. 最后按 [dev/TrinityWar 前端 Mock 数据退场计划 v0.1.md](dev/TrinityWar 前端 Mock 数据退场计划 v0.1.md) 逐步移除前端临时种子表。
...
你现在只负责生成 SeedDefinition 的主数据 seed 文件。请以 [docs/design/Trinity War 首发农场与金币曲线首稿 v0.1.md](docs/design/Trinity War 首发农场与金币曲线首稿 v0.1.md) 为主来源，以 [dev/TrinityWar Prisma Seed 与初始静态数据装载计划 v0.1.md](dev/TrinityWar Prisma Seed 与初始静态数据装载计划 v0.1.md) 为执行边界。不要顺手生成 PlayerSeedInventory 初始化逻辑。
