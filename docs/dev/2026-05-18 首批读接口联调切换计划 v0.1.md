...
3. 模块骨架：[dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md](dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md)
4. Migration 切分计划：[dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md](dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md)
5. 命令链路事务与幂等：[dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md](dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md)
...
你现在只负责把 [接口名] 读接口接入真实数据库读取链路，并按 [dev/2026-05-18 首批读接口联调切换计划 v0.1.md](dev/2026-05-18 首批读接口联调切换计划 v0.1.md) 保留当前前端 DTO 形状。不要顺手改写接口，不要顺手拆 scene-content。
