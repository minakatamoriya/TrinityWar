...
### [ ] TW-BE-003 落地 Migration 001 与 002
...
### [ ] TW-BE-004 落地 Migration 003 与 004
...
### [ ] TW-BE-008 接通 home-summary 真实读接口
...
### [ ] TW-BE-014 接通任务奖励、待领取收益、训练队列命令链路
...
1. [ ] worker 可独立运行。
2. [ ] raid settlement 不是复制另一套规则，而是复用主规则层。
3. [ ] 战报与结算结果可查询。
