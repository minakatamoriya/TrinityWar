...
1. Prisma seed 与静态数据：[dev/2026-05-23 Prisma Seed 与初始静态数据装载计划 v0.1.md](dev/2026-05-23 Prisma Seed 与初始静态数据装载计划 v0.1.md)
...
你现在只负责生成 PlayerInitializationService 或等价方案。请严格按 [dev/2026-05-18 后端初始建档与首批测试账号方案 v0.1.md](dev/2026-05-18 后端初始建档与首批测试账号方案 v0.1.md) 初始化玩家私有状态。不要顺手生成全局 seed 主数据。
