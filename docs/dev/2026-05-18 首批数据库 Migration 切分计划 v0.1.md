...
本文件是对 [dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md](dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md) 中“首批 migration 拆分建议”的细化版，不是替代版。

它同时要和下面几份文档保持一致：

1. 总计划：[dev/2026-05-18 AI 后端总计划 v0.1.md](dev/2026-05-18 AI 后端总计划 v0.1.md)
2. Prisma/schema 规划：[dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md](dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md)
3. 接口契约：[dev/2026-05-18 首批真实接口契约清单 v0.1.md](dev/2026-05-18 首批真实接口契约清单 v0.1.md)
4. Service 分层：[dev/2026-05-18 后端 Service 分层设计 v0.1.md](dev/2026-05-18 后端 Service 分层设计 v0.1.md)
5. 模块骨架：[dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md](dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md)
6. 命令链路事务与幂等：[dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md](dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md)
