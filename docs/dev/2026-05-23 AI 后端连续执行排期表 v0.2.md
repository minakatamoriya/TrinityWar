...
AI 默认不得直接把任务改成 `[x]`。AI 完成实现和自测后，可以把任务改成 `[~]`，并在 [docs/2026-05-22 任务开发日志.md](../2026-05-22 任务开发日志.md) 追加执行记录。只有人类验收通过后，才把状态改成 `[x]`。
...
AI 完成实现后，应追加 [docs/2026-05-22 任务开发日志.md](../2026-05-22 任务开发日志.md) 记录，并把当前任务状态改为 `[~]`。人工验收通过后，再把任务状态改为 `[x]`。
...
1. [docs/dev/2026-05-18 AI 后端总计划 v0.1.md](2026-05-18 AI 后端总计划 v0.1.md)
2. [docs/dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md](2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md)
3. [docs/dev/2026-05-18 后端 Service 分层设计 v0.1.md](2026-05-18 后端 Service 分层设计 v0.1.md)
...
1. [docs/dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md](2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md)
2. [docs/dev/2026-05-18 后端 Service 分层设计 v0.1.md](2026-05-18 后端 Service 分层设计 v0.1.md)
...
1. [docs/dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md](2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md)
2. [docs/dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md](2026-05-18 首批数据库 Migration 切分计划 v0.1.md)
...
1. [docs/dev/2026-05-23 Prisma Seed 与初始静态数据装载计划 v0.1.md](2026-05-23 Prisma Seed 与初始静态数据装载计划 v0.1.md)
2. [docs/dev/2026-05-18 后端初始建档与首批测试账号方案 v0.1.md](2026-05-18 后端初始建档与首批测试账号方案 v0.1.md)
...
1. [docs/dev/2026-05-18 首批真实接口契约清单 v0.1.md](2026-05-18 首批真实接口契约清单 v0.1.md)
2. [docs/dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md](2026-05-18 首批数据库 Migration 切分计划 v0.1.md)
3. [docs/dev/2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md](2026-05-18 首批 NestJS 模块拆分与目录骨架规划 v0.1.md)
...
1. [docs/dev/2026-05-18 首批读接口联调切换计划 v0.1.md](2026-05-18 首批读接口联调切换计划 v0.1.md)
2. [docs/dev/2026-05-18 首批真实接口契约清单 v0.1.md](2026-05-18 首批真实接口契约清单 v0.1.md)
...
1. [docs/dev/2026-05-18 首批读接口联调切换计划 v0.1.md](2026-05-18 首批读接口联调切换计划 v0.1.md)
2. [docs/dev/2026-05-18 后端 Service 分层设计 v0.1.md](2026-05-18 后端 Service 分层设计 v0.1.md)
3. [docs/dev/2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md](2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md)
...
1. [docs/dev/2026-05-18 首批读接口联调切换计划 v0.1.md](2026-05-18 首批读接口联调切换计划 v0.1.md)
2. [docs/dev/2026-05-18 前端 Mock 数据退场计划 v0.1.md](2026-05-18 前端 Mock 数据退场计划 v0.1.md)
...
1. [docs/dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md](2026-05-18 首批写链路事务与幂等策略清单 v0.1.md)
2. [docs/dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md](2026-05-18 首批数据库 Migration 切分计划 v0.1.md)
...
1. [docs/dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md](2026-05-18 首批数据库 Migration 切分计划 v0.1.md)
2. [docs/dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md](2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md)
3. [docs/dev/2026-05-23 掠夺订单与异步结算专项设计 v0.1.md](2026-05-23 掠夺订单与异步结算专项设计 v0.1.md)
...
1. [docs/dev/2026-05-18 首批真实接口契约清单 v0.1.md](2026-05-18 首批真实接口契约清单 v0.1.md)
2. [docs/dev/2026-05-23 掠夺订单与异步结算专项设计 v0.1.md](2026-05-23 掠夺订单与异步结算专项设计 v0.1.md)
3. [docs/dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md](2026-05-18 首批写链路事务与幂等策略清单 v0.1.md)
...
1. [docs/dev/2026-05-23 掠夺订单与异步结算专项设计 v0.1.md](2026-05-23 掠夺订单与异步结算专项设计 v0.1.md)
2. [docs/dev/2026-05-18 后端 Service 分层设计 v0.1.md](2026-05-18 后端 Service 分层设计 v0.1.md)
3. [docs/dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md](2026-05-18 首批写链路事务与幂等策略清单 v0.1.md)
...
1. [docs/dev/2026-05-18 前端 Mock 数据退场计划 v0.1.md](2026-05-18 前端 Mock 数据退场计划 v0.1.md)
2. [docs/dev/2026-05-18 首批读接口联调切换计划 v0.1.md](2026-05-18 首批读接口联调切换计划 v0.1.md)
...
1. [docs/dev/2026-05-18 首批 Admin API 契约清单 v0.1.md](2026-05-18 首批 Admin API 契约清单 v0.1.md)
2. [docs/dev/2026-05-23 管理后台首批只读视图与排障面板规划 v0.1.md](2026-05-23 管理后台首批只读视图与排障面板规划 v0.1.md)
...
1. [docs/design/2026-05-18 灵宠等级养成与五行战斗设计草案 v0.1.md](../design/2026-05-18%20灵宠等级养成与五行战斗设计草案%20v0.1.md)
2. [docs/dev/2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md](2026-05-18 首批数据库表与 Prisma Schema 草案 v0.1.md)
3. [docs/dev/2026-05-18 首批数据库 Migration 切分计划 v0.1.md](2026-05-18 首批数据库 Migration 切分计划 v0.1.md)
...
1. [docs/design/2026-05-18 灵宠等级养成与五行战斗设计草案 v0.1.md](../design/2026-05-18%20灵宠等级养成与五行战斗设计草案%20v0.1.md)
2. [docs/dev/2026-05-18 首批写链路事务与幂等策略清单 v0.1.md](2026-05-18 首批写链路事务与幂等策略清单 v0.1.md)
3. TW-BE-SPIRIT-001。
...
1. [docs/design/2026-05-18 灵宠等级养成与五行战斗设计草案 v0.1.md](../design/2026-05-18%20灵宠等级养成与五行战斗设计草案%20v0.1.md)
2. [docs/dev/2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md](2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md)
3. TW-BE-SPIRIT-001。
...
1. [docs/design/2026-05-18 游戏设计草案 v0.2.md](../design/2026-05-18%20游戏设计草案%20v0.2.md)
2. [docs/dev/2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md](2026-05-23 Battle Report 与 Raid Page 前端联调字段清单 v0.1.md)
...
1. 本排期表前面所有已完成项。
2. [docs/dev/2026-05-18 AI 后端总计划 v0.1.md](2026-05-18 AI 后端总计划 v0.1.md)
...
3. [docs/design/2026-05-18 灵宠等级养成与五行战斗设计草案 v0.1.md](../design/2026-05-18%20灵宠等级养成与五行战斗设计草案%20v0.1.md)
...
## 十一、2026-05-24 首发轻量化全栈改造专项

本专项用于承接 2026-05-24 重新确定的首发轻量化规则。虽然本文原本是后端连续执行排期表，但本轮改造会同时影响数据库、共享契约、后端、游戏前端和管理后台，因此这里按全栈执行顺序补充任务。

前置设计文档：

1. [docs/design/2026-05-24 首发轻量化经济与地契开田重设计 v0.1.md](../design/2026-05-24 首发轻量化经济与地契开田重设计 v0.1.md)

本专项统一目标：

1. 金库改为无上限安全钱包。
2. 取消主城税收。
3. 取消所有金币容量、溢出、临时待领取、容量承接相关规则。
4. 主城等级退出首发核心闸门。
5. 开田从主城等级改为地契任务。
6. 阵营从每小时金币分红改为每日俸禄，俸禄以材料为主、少量金币为辅。
7. 保留领地升级分支，但不再依赖主城等级。
8. 清理前端、后台、mock、文案和旧接口中的旧口径。

### [~] TW-LITE-001 盘点旧口径落点并生成改造清单

预计工期：0.5 天

目标：

1. 全局盘点主城税收、金库容量、金币溢出、临时待领取、主城等级开田、每小时阵营分红的代码落点。
2. 明确哪些字段本轮停用，哪些字段后续再物理删除。
3. 输出一份执行顺序清单，避免直接大改时遗漏前后端契约。

前置文档：

1. 2026-05-24 首发轻量化经济与地契开田重设计。
2. 本排期表“统一执行规则”。
...
3. `services/game-server/src/lib/game-balance.js`
4. `services/game-server/src/client-read`
5. `services/game-server/src/client-command`
6. `services/game-server/src/raid`
7. `apps/game-client/src`
8. `apps/game-admin/src`

产出要求：

1. 不做业务代码修改，除非只是补一份开发笔记。
2. 在最终输出中列出必须修改的文件和旧口径关键词。
3. 标明高风险点，例如 migration、shared DTO 破坏性变更、前端 mock 兼容。
...
### [~] TW-LITE-002 新增数据库结构：地契进度与阵营每日俸禄
...
1. 新增地契任务进度表。
2. 新增阵营每日俸禄领取表。
3. 暂不物理删除旧金币容量和税收字段，先保证平滑迁移。

建议 AI 操作范围：

1. `services/game-server/prisma/schema.prisma`
2. `services/game-server/prisma/migrations`
3. 必要的 Prisma generate/validate 脚本。

建议模型：

```text
PlayerLandDeedProgress
- id
- playerId
- deedKey
- status
...
1. Prisma schema 增加模型、索引和唯一约束。
2. migration 可应用。
3. 不删除旧字段。

最小验证建议：

1. `npm run prisma:validate --workspace @trinitywar/game-server` 或项目现有 Prisma validate 命令。
2. `npx prisma generate` 或项目现有 generate 命令。
3. 如本地数据库可用，执行 migrate deploy。
...
### [~] TW-LITE-003 重写 shared 契约：移除容量/税收/溢出口径，新增地契与俸禄 DTO

预计工期：0.5 到 1 天

目标：

1. 共享类型不再向前端暴露金币容量、税收待领取、溢出金币、临时待领取等旧概念。
2. 新增地契进度和阵营每日俸禄相关 DTO。
3. 调整领地升级类型，停止暴露主城、金库、田地位升级。

建议 AI 操作范围：

1. `packages/shared/src/index.ts`
2. 必要时同步后端和前端的临时编译修复，但不要实现完整业务。

产出要求：

1. `HomeResourceSummary` 金币展示支持单值。
2. 删除或废弃 `ClientPendingClaimSource` 中的 `tax`、`raid-overflow` 旧语义。
3. 删除或废弃 `acceptOverflowLoss`、`overflowGold`、`vaultCapacity` 对外展示。
4. 新增 `ClientLandDeedProgress`。
5. 新增 `ClientFactionStipendSummary`。
6. 新增阵营俸禄领取请求/响应类型。
7. 升级类型只保留领地科技：护山结界、灵脉灌溉、丰熟延时、阵营供奉台等。

最小验证建议：

1. `npm run build --workspace @trinitywar/shared`

验收清单：

1. [ ] shared 不再要求前端处理金币容量。
2. [ ] shared 不再要求前端处理税收待领取。
3. [ ] shared 已包含地契进度 DTO。
4. [ ] shared 已包含阵营每日俸禄 DTO。
5. [ ] shared 构建通过。

### [~] TW-LITE-004 更新数值总表与领地科技配置
...
1. 删除或停用 `tax` 相关导出。
2. 删除或停用 `vaultLevels` 的容量收益。
3. 删除或停用 `FIELD_SLOT_UNLOCK_CONFIG` 的主城等级逻辑。
4. 删除 `pendingClaimTech`。
5. 新增 `LAND_DEED_CONFIG`。
6. 新增 `FACTION_STIPEND_CONFIG`。
7. 新增或整理领地科技配置：
   - `protectionTech`
   - `farmYieldTech`
   - `ripeWindowTech`
...
1. `npm run typecheck --workspace @trinitywar/game-server`
...
### [~] TW-LITE-005 后端读模型改造：首页、农场、建筑、阵营不再展示旧口径

预计工期：1 到 1.5 天

目标：

1. 首页不再展示金币容量、税收待领取、临时待领取。
2. 农场锁田文案改为地契任务。
3. 建筑页改为领地科技页数据，不再返回主城、金库、田地位升级。
4. 阵营页展示每日俸禄和贡献档位，不再展示每小时金币分红。
...
3. `services/game-server/src/client-read/client-read.service.ts`
4. 必要的 repository/read model 类型。

产出要求：

1. home summary 的金币资源是单值。
2. `pendingClaims` 不再包含税收或溢出金币。
3. farm fields 的 locked description 来自地契进度。
4. building scene 只返回领地科技升级项。
5. faction scene 返回每日俸禄摘要。

最小验证建议：

1. `npm run typecheck --workspace @trinitywar/game-server`
2. 后端 build。
3. 如可启动服务，手动请求 `home-summary` 和 `scene-content`。
...
2. [ ] 首页不再出现金币容量。
3. [ ] 农场锁田不再提主城等级。
4. [ ] 建筑页不再返回主城/金库/田地位升级。
5. [ ] 阵营页不再展示每小时分红。

### [~] TW-LITE-006 后端写链路改造：金币直接入账并停用溢出

预计工期：1 到 1.5 天

目标：

1. 收菜、任务奖励、掠夺结算、通知奖励等金币奖励直接进入金库。
2. 不再检查 `vaultCapacity`。
3. 不再产生 `overflowGold` 和临时待领取金币。
4. `claim-pending` 中税收和溢出来源退场。

建议 AI 操作范围：

1. `services/game-server/src/client-command/client-command.service.ts`
2. `services/game-server/src/client-command/field-command-rule.service.ts`
3. `services/game-server/src/raid/raid-settlement-rule.service.ts`
4. `services/game-server/src/raid/raid-settlement.service.ts`
5. `services/game-server/src/notification`
6. 相关 audit 写入。

产出要求：

1. 所有金币入账不再受容量限制。
2. 收菜响应 `overflowGold` 固定为 0 或从契约中移除。
3. 掠夺响应不再产生临时领取。
4. 停用税收类 `claim-pending`。
5. 钱包审计日志仍保留前后值。
...
### [~] TW-LITE-007 实现地契任务推进与开田

预计工期：1 到 2 天

目标：

1. 根据收菜次数、阵营贡献、成功掠夺次数推进地契任务。
2. 达成条件后解锁对应田地。
3. 支持第 4 块田的进攻路径和经营替代路径。

建议 AI 操作范围：

1. 新增 `services/game-server/src/land-deed` 或放入合适的 client-command 子服务。
2. `client-command.service.ts`
3. 收菜、阵营捐献、掠夺结算相关写链路。
4. 玩家初始化服务。
...
```text
第 1 块田：默认拥有
第 2 块田：账号创建满 1 天 + 累计收菜 3 次
第 3 块田：累计收菜 10 次 + 累计阵营贡献 100
第 4 块田：累计收菜 30 次 + 累计阵营贡献 500 + 成功掠夺 3 次
第 4 块田替代：累计收菜 45 次 + 累计阵营贡献 500
```
...
1. 新玩家只解锁第 1 块田。
2. 地契进度可读、可展示。
3. 达成地契后自动或领取式解锁田地，规则需明确。
4. 解锁田地后 `player_field_slot.status` 正确变为可播种状态。

最小验证建议：

1. 后端 typecheck/build。
2. 构造测试玩家，模拟收菜、捐献、掠夺，确认田地解锁。
3. 数据库查询 `player_field_slot` 与地契进度表。
...
1. 阵营贡献不再产生每小时金币分红。
2. 玩家每日可领取一次阵营俸禄。
3. 俸禄按贡献档位发放，材料为主，少量金币为辅。
4. 阵营供奉台科技可影响材料俸禄，但不放大金币返还。

建议 AI 操作范围：

1. `services/game-server/src/client-command/client-command.service.ts`
2. `services/game-server/src/client-command/dto.ts`
3. `services/game-server/src/client-read/scene-content.assembler.ts`
4. `services/game-server/src/lib/game-balance.js`
...
1. 新增领取阵营俸禄命令。
2. 每日幂等或唯一领取控制。
3. 发放金币、种子、兽魂等资源时有审计或记录。
4. 阵营页读模型能展示今日可领和已领状态。

最小验证建议：

1. shared build。
2. 后端 typecheck/build。
3. HTTP 手动请求一次领取，重复领取应返回明确结果。
...
### [~] TW-LITE-009 玩家初始化、seed 与测试账号重置
...
1. 新玩家初始化符合新规则。
2. 开发测试账号覆盖 1 田、2 田、3 田、4 田场景。
3. 不再初始化依赖金库容量和主城税收的状态。

建议 AI 操作范围：

1. `services/game-server/src/seed/player-initialization.service.ts`
2. `services/game-server/prisma/seed.ts`
...
### [~] TW-LITE-010 游戏前端改造：首页、农场、建筑、阵营
...
1. 游戏前端完全改成新口径展示。
2. 删除旧容量、税收、溢出、主城等级开田文案。
3. 接入地契任务和阵营每日俸禄。

建议 AI 操作范围：

1. `apps/game-client/src/ui/scenes/HomeScene.tsx`
2. `apps/game-client/src/ui/scenes/FarmScene.tsx`
3. `apps/game-client/src/ui/scenes/BuildingScene.tsx`
4. `apps/game-client/src/ui/scenes/FactionScene.tsx`
5. `apps/game-client/src/api.ts`
6. `apps/game-client/src/mockData.ts`
7. `apps/game-client/src/styles.css`
...
1. `npm run build --workspace @trinitywar/game-client`
2. 本地启动前端，检查首页、农场、建筑、阵营四页。
...
### [~] TW-LITE-011 管理后台改造：玩家排查与配置页同步新规则

预计工期：1 到 2 天

目标：

1. 后台玩家详情不再围绕旧主城/金库容量/税收字段展示。
2. 后台能查看地契进度、田地解锁状态、阵营俸禄领取状态。
3. 配置页从主城等级配置转向领地科技、地契任务、阵营俸禄档位。

建议 AI 操作范围：

1. `apps/game-admin/src/views/PlayerInfoView.tsx`
2. `apps/game-admin/src/views/CastleLevelsView.tsx`
3. `apps/game-admin/src/views/DashboardView.tsx`
4. `apps/game-admin/src/domain/labels.ts`
5. `apps/game-admin/src/domain/config.ts`
6. `services/game-server/src/admin-readonly`
...
2. 玩家详情展示阵营俸禄领取状态。
3. 后台隐藏或弱化废弃字段。
4. 配置查看页不再叫主城等级配置，或明确标注旧配置已停用。

最小验证建议：

1. `npm run build --workspace @trinitywar/game-admin`
2. 如后端可启动，手动打开玩家详情。

验收清单：

1. [ ] 后台不再把 vaultCapacity 作为核心字段。
2. [ ] 后台不再把 pendingTaxGold 作为核心字段。
3. [ ] 后台可排查地契状态。
4. [ ] 后台可排查阵营俸禄领取。

### [~] TW-LITE-012 全局旧口径清理与回归验证
...
1. 全仓搜索：
   ...
   - `overflowGold`
2. shared、后端、前端、后台构建。
3. [docs/2026-05-22 任务开发日志.md](../2026-05-22 任务开发日志.md)

产出要求：

1. 旧口径只允许存在于历史文档或明确废弃兼容字段中。
2. 当前业务代码和 UI 不再展示旧规则。
3. 追加开发日志。
4. 把已实现但待人工验收的任务标记为 `[~]`。
...
1. `npm run build --workspace @trinitywar/shared`
2. `npm run typecheck --workspace @trinitywar/game-server`
3. `npm run build --workspace @trinitywar/game-server`
4. `npm run build --workspace @trinitywar/game-client`
5. `npm run build --workspace @trinitywar/game-admin`
...
3. [ ] 游戏前端构建通过。
4. [ ] 管理后台构建通过。
5. [ ] 当前 UI 不再出现旧税收/容量/溢出口径。

## 十二、2026-05-24 专项建议起跑顺序

如果从本轮轻量化改造开始执行，建议严格按下面顺序：
...
不要先改前端页面。原因是本轮前端展示强依赖 shared 契约和后端读模型，先改 UI 会导致大量 mock 返工。

不要第一轮就物理删除旧数据库字段。原因是当前系统已有审计、读模型、测试账号和后台依赖旧字段，先停用业务语义更稳，等全链路新规则跑通后再做数据库瘦身 migration。
