...
1. 读接口联调切换计划：[dev/2026-05-18 首批读接口联调切换计划 v0.1.md](dev/2026-05-18 首批读接口联调切换计划 v0.1.md)
...
4. 接口契约：[dev/2026-05-18 首批真实接口契约清单 v0.1.md](dev/2026-05-18 首批真实接口契约清单 v0.1.md)
...
你现在只负责收口 [mock 类型名]，范围仅限 [apps/game-client/src/api.ts](apps/game-client/src/api.ts) 中对应逻辑。请按照 [dev/2026-05-18 前端 Mock 数据退场计划 v0.1.md](dev/2026-05-18 前端 Mock 数据退场计划 v0.1.md) 把它从默认主链路移出，但保留显式 mock 模式能力。不要顺手改其他 mock 类别。
