...
export type ModuleKey = 'dashboard' | 'player' | 'order' | 'notifications' | 'season' | 'shareAssist' | 'robotTest' | 'designDocs' | 'spiritConfig' | 'seedConfig' | 'taskConfig' | 'castleLevels' | 'system';
