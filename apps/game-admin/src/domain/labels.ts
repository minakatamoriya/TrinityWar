...
const fieldLabels: Record<string, string> = {
  ...
  growSeconds: '生长秒数',
  matureSeconds: '成熟秒数',
  ripeWindowSeconds: '丰熟窗口秒数',
  baseYieldGold: '基础产金',
  harvestSeedReturn: '收获返种',
  strategyNote: '策略说明',
  upgradeCost: '升级消耗',
  cumulativeCost: '累计消耗',
  taxPerHour: '每小时税收',
  ...
  protectionTechLevel: '护山结界',
  farmYieldTechLevel: '灵脉灌溉',
  ripeWindowTechLevel: '时序观象台',
  pendingClaimTechLevel: '庶务司',
  buildingVersion: '建筑版本',
  totalCount: '总战力',
  availableCount: '可用战力',
  frozenCount: '冻结战力',
  woundedCount: '受伤战力',
