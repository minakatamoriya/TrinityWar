...
export const seedCatalog: SeedCatalogItem[] = [
  ...
  { id: 'ninglucao', name: '凝露草', rarity: 'common', sortOrder: 30, description: '普通、长线安睡种，10 小时成熟，适合睡前或上班前规划。', lore: '叶尖常凝夜露，晨时如泪珠滚落，有清心明目之效。低阶弟子多用其露水研磨朱砂画符，成功率能稍许提升。', stageGold: { growing: 100, mature: 800, withered: 400 }, growthSeconds: 36000, unlockedByDefault: false },
