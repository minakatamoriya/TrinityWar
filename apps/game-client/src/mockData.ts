...
export const mockHomeSummary: HomeSummaryResponse = {
  ...
  primaryActions: [
    { key: 'building', title: '工坊', description: '升级领地科技' },
    ...
    extensions: [
      {
        ...
        costText: '消耗 800 金币',
        action: { label: '升级', target: 'building', tone: 'secondary' },
      },
      {
        id: 'farmYieldTech',
        title: '灵脉灌溉',
        levelText: 'Lv.0 -> Lv.1',
        description: '提升田地成熟与丰熟收益。',
      ...
      },
      {
        ...
        title: '阵营供奉台',
        levelText: 'Lv.0 -> Lv.1',
        description: '提升阵营俸禄材料品质，不放大金币返还。',
        effectText: '当前 材料俸禄 +0%，升级后 材料俸禄 +2%。',
        costText: '消耗 1,200 金币',
        action: { label: '升级', target: 'building', tone: 'secondary' },
      },
    ],
  },
    ...
    landDeeds: [
      {
        deedKey: 'field-2',
        title: '二号地契',
        description: '完成基础收菜和首次掠夺后开启第 2 块田。',
        status: 'claimed',
        targetFieldSlotIndex: 2,
        requirements: [
          { key: 'harvestCount', label: '累计收菜', current: 3, target: 3, completed: true },
          { key: 'successfulRaidCount', label: '成功掠夺', current: 1, target: 1, completed: true },
        ],
      ...
      },
      {
        deedKey: 'field-3',
        title: '三号地契',
        description: '通过稳定收菜、掠夺和阵营上缴开启第 3 块田。',
        status: 'claimed',
        targetFieldSlotIndex: 3,
        requirements: [
          { key: 'harvestCount', label: '累计收菜', current: 10, target: 10, completed: true },
          { key: 'successfulRaidCount', label: '成功掠夺', current: 8, target: 8, completed: true },
      ...
      },
      {
        deedKey: 'field-4',
        title: '四号地契',
        description: '完成更高强度的收菜、掠夺、阵营上缴和升级后开启第 4 块田。',
        status: 'in-progress',
        targetFieldSlotIndex: 4,
        requirements: [
          { key: 'harvestCount', label: '累计收菜', current: 18, target: 30, completed: false },
          { key: 'successfulRaidCount', label: '成功掠夺', current: 8, target: 20, completed: false },
          { key: 'factionDonateCount', label: '阵营上缴次数', current: 3, target: 8, completed: false },
          { key: 'buildingUpgradeCount', label: '完成升级次数', current: 2, target: 5, completed: false },
        ],
        alternativeRequirements: [],
        canClaim: false,
        claimedAt: null,
