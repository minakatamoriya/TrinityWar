import type { AnySpiritBattleTraitCode } from './spiritBattleRules.js';
export declare const APP_NAME = "TrinityWar";
export declare const API_PREFIX = "/api";
export declare const CLIENT_API_PREFIX = "/api/client";
export declare const ADMIN_API_PREFIX = "/api/admin";
export declare const DOCS_ROUTE = "/docs";
export declare const ARMY_RECRUIT_GOLD_COST_PER_UNIT = 100;
export declare const ARMY_RECRUIT_SECONDS_PER_UNIT = 60;
export declare function formatSeasonLabel(seasonNumber: number): string;
...
export declare const CLIENT_SPIRIT_TRAIT_ROLL_RULES: Record<ClientSpiritActiveRollMode, ClientSpiritTraitRollRule>;
export declare const CLIENT_SPIRIT_TRAIT_ROLL_PLAN_ORDER: ClientSpiritActiveRollMode[];
export declare function getBasicSpiritTraitRollGoldCost(level: number): number;
...
export declare const CLIENT_SPIRIT_INNATE_TRAITS: Record<string, ClientSpiritInnateTrait>;
export declare function getClientSpiritInnateTrait(spiritId: string | null | undefined): ClientSpiritInnateTrait | null;
...
export type ClientCodexPromptType = 'spirit-codex-visible' | 'spirit-compose-ready' | 'plant-discovered' | 'plant-unlocked';
...
export type ClientRaidBattleStep = {
    ...
    max: number;
    durationMs: number;
    floatingText?: string | false;
    floatingTone?: ClientRaidBattleFloatingTone;
    round?: number;
    bloodRound?: number;
} | {
    type: 'return';
...
export type ClientSocialFeedType = 'friend_watered_field' | 'friend_revived_field' | 'friend_guarded_field' | 'friend_requested' | 'friend_accepted' | 'friend_rejected' | 'friend_deleted' | 'team_challenge_invited' | 'team_challenge_accepted' | 'enemy_raided' | 'revenge_available' | 'faction_help_requested';
