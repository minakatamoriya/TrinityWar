...
\restrict 4hqImNtNqcDsmihQ8fyJeS8xNvSEssYJhDPLHIcfY24OWbtHUW9hCEIz9gil78N
...
--
-- Name: player_raid_pair_daily_state_attacker_player_id_defender_play_k; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_raid_pair_daily_state_attacker_player_id_defender_play_k ON public.player_raid_pair_daily_state USING btree (attacker_player_id, defender_player_id, date_key);
...
--
-- Name: spirit_trait_roll_log_player_id_status_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX spirit_trait_roll_log_player_id_status_created_at_idx ON public.spirit_trait_roll_log USING btree (player_id, status, created_at);
...
\unrestrict 4hqImNtNqcDsmihQ8fyJeS8xNvSEssYJhDPLHIcfY24OWbtHUW9hCEIz9gil78N
