...
-- CreateEnum
CREATE TYPE "SocialFeedType" AS ENUM ('FRIEND_WATERED_FIELD', 'FRIEND_GUARDED_FIELD', 'FRIEND_REQUESTED', 'FRIEND_ACCEPTED', 'FRIEND_REJECTED', 'TEAM_CHALLENGE_INVITED', 'TEAM_CHALLENGE_ACCEPTED', 'ENEMY_RAIDED', 'REVENGE_AVAILABLE', 'FACTION_HELP_REQUESTED');

-- CreateEnum
CREATE TYPE "SocialAssistType" AS ENUM ('WATER_FIELD', 'HARVEST_FIELD', 'GUARD_FIELD', 'RECOVER_SPIRIT', 'FACTION_TASK_HELP');
