...
\restrict 00pxb5Gfevt6TC4bp8uRUPaZ0UI0PnYzzkYXlS12PuU9G97ymBEkC1LzWjnHVzo
...
--
-- Name: faction_spirit_battle_stat; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.faction_spirit_battle_stat (
    id text NOT NULL,
    season_number integer NOT NULL,
    faction_id text NOT NULL,
...
--
-- Name: player_raid_daily_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.player_raid_daily_state (
    id text NOT NULL,
    player_id text NOT NULL,
    date_key text NOT NULL,
    normal_raid_attempts_used integer DEFAULT 0 NOT NULL,
    raid_refreshes_used integer DEFAULT 0 NOT NULL,
    successful_defense_raid_count integer DEFAULT 0 NOT NULL,
    extra_raid_attempts_purchased integer DEFAULT 0 NOT NULL,
    extra_refreshes_purchased integer DEFAULT 0 NOT NULL,
    created_at timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp(3) without time zone NOT NULL
);
...
--
-- Name: player_raid_pair_daily_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.player_raid_pair_daily_state (
    id text NOT NULL,
...
CREATE TABLE public.player_season_state (
    ...
    faction_choice_used_at timestamp(3) without time zone
);
...
--
-- Name: spirit_battle_instance_stat; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.spirit_battle_instance_stat (
    id text NOT NULL,
    season_number integer NOT NULL,
    faction_id text NOT NULL,
    player_id text NOT NULL,
...
--
-- Name: faction_spirit_battle_stat faction_spirit_battle_stat_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.faction_spirit_battle_stat
    ADD CONSTRAINT faction_spirit_battle_stat_pkey PRIMARY KEY (id);
...
--
-- Name: player_raid_daily_state player_raid_daily_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player_raid_daily_state
    ADD CONSTRAINT player_raid_daily_state_pkey PRIMARY KEY (id);


--
-- Name: player_raid_pair_daily_state player_raid_pair_daily_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player_raid_pair_daily_state
    ADD CONSTRAINT player_raid_pair_daily_state_pkey PRIMARY KEY (id);
...
--
-- Name: spirit_battle_instance_stat spirit_battle_instance_stat_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.spirit_battle_instance_stat
    ADD CONSTRAINT spirit_battle_instance_stat_pkey PRIMARY KEY (id);
...
--
-- Name: faction_spirit_battle_stat_faction_spirit_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX faction_spirit_battle_stat_faction_spirit_idx ON public.faction_spirit_battle_stat USING btree (faction_id, spirit_definition_id);


--
-- Name: faction_spirit_battle_stat_season_faction_spirit_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX faction_spirit_battle_stat_season_faction_spirit_key ON public.faction_spirit_battle_stat USING btree (season_number, faction_id, spirit_definition_id);


--
-- Name: faction_spirit_battle_stat_season_faction_win_battle_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX faction_spirit_battle_stat_season_faction_win_battle_idx ON public.faction_spirit_battle_stat USING btree (season_number, faction_id, win_count, battle_count);
...
--
-- Name: player_invite_relation_inviter_player_id_invited_openid_has_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_invite_relation_inviter_player_id_invited_openid_has_key ON public.player_invite_relation USING btree (inviter_player_id, invited_openid_hash);
...
--
-- Name: player_raid_daily_state_date_key_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX player_raid_daily_state_date_key_idx ON public.player_raid_daily_state USING btree (date_key);


--
-- Name: player_raid_daily_state_player_id_date_key_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_raid_daily_state_player_id_date_key_key ON public.player_raid_daily_state USING btree (player_id, date_key);


--
-- Name: player_raid_pair_daily_state_attacker_player_id_date_key_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX player_raid_pair_daily_state_attacker_player_id_date_key_idx ON public.player_raid_pair_daily_state USING btree (attacker_player_id, date_key);


--
-- Name: player_raid_pair_daily_state_attacker_player_id_defender_pl_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_raid_pair_daily_state_attacker_player_id_defender_pl_key ON public.player_raid_pair_daily_state USING btree (attacker_player_id, defender_player_id, date_key);


--
-- Name: player_raid_pair_daily_state_defender_player_id_date_key_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX player_raid_pair_daily_state_defender_player_id_date_key_idx ON public.player_raid_pair_daily_state USING btree (defender_player_id, date_key);


--
-- Name: player_season_achievement_player_id_season_number_achieveme_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_season_achievement_player_id_season_number_achieveme_key ON public.player_season_achievement USING btree (player_id, season_number, achievement_key);
...
--
-- Name: player_season_reward_grant_player_id_season_number_reward_t_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_season_reward_grant_player_id_season_number_reward_t_key ON public.player_season_reward_grant USING btree (player_id, season_number, reward_type);
...
--
-- Name: player_social_relation_player_id_target_player_id_relation__key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_social_relation_player_id_target_player_id_relation__key ON public.player_social_relation USING btree (player_id, target_player_id, relation_type);


--
-- Name: player_social_relation_target_player_id_relation_type_statu_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX player_social_relation_target_player_id_relation_type_statu_idx ON public.player_social_relation USING btree (target_player_id, relation_type, status);
...
--
-- Name: player_spirit_slot_spirit_instance_id_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX player_spirit_slot_spirit_instance_id_key ON public.player_spirit_slot USING btree (spirit_instance_id);
...
--
-- Name: raid_target_pool_owner_player_id_target_player_id_slot_inde_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX raid_target_pool_owner_player_id_target_player_id_slot_inde_key ON public.raid_target_pool USING btree (owner_player_id, target_player_id, slot_index, refresh_batch_no);
...
--
-- Name: share_assist_campaign_owner_player_id_campaign_type_status__idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX share_assist_campaign_owner_player_id_campaign_type_status__idx ON public.share_assist_campaign USING btree (owner_player_id, campaign_type, status, created_at);
...
--
-- Name: spirit_battle_instance_stat_player_id_season_number_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX spirit_battle_instance_stat_player_id_season_number_idx ON public.spirit_battle_instance_stat USING btree (player_id, season_number);


--
-- Name: spirit_battle_instance_stat_season_number_faction_id_battle_cou; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX spirit_battle_instance_stat_season_number_faction_id_battle_cou ON public.spirit_battle_instance_stat USING btree (season_number, faction_id, battle_count, win_count);


--
-- Name: spirit_battle_instance_stat_season_number_spirit_instance_id_ke; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX spirit_battle_instance_stat_season_number_spirit_instance_id_ke ON public.spirit_battle_instance_stat USING btree (season_number, spirit_instance_id);


--
-- Name: spirit_battle_instance_stat_spirit_definition_id_season_number_; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX spirit_battle_instance_stat_spirit_definition_id_season_number_ ON public.spirit_battle_instance_stat USING btree (spirit_definition_id, season_number);


--
-- Name: spirit_battle_instance_stat_spirit_instance_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX spirit_battle_instance_stat_spirit_instance_id_idx ON public.spirit_battle_instance_stat USING btree (spirit_instance_id);
...
--
-- Name: player_raid_daily_state player_raid_daily_state_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player_raid_daily_state
    ADD CONSTRAINT player_raid_daily_state_player_id_fkey FOREIGN KEY (player_id) REFERENCES public.player(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: player_raid_pair_daily_state player_raid_pair_daily_state_attacker_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player_raid_pair_daily_state
    ADD CONSTRAINT player_raid_pair_daily_state_attacker_player_id_fkey FOREIGN KEY (attacker_player_id) REFERENCES public.player(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: player_raid_pair_daily_state player_raid_pair_daily_state_defender_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player_raid_pair_daily_state
    ADD CONSTRAINT player_raid_pair_daily_state_defender_player_id_fkey FOREIGN KEY (defender_player_id) REFERENCES public.player(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: spirit_battle_instance_stat spirit_battle_instance_stat_faction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.spirit_battle_instance_stat
    ADD CONSTRAINT spirit_battle_instance_stat_faction_id_fkey FOREIGN KEY (faction_id) REFERENCES public.faction(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: spirit_battle_instance_stat spirit_battle_instance_stat_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.spirit_battle_instance_stat
    ADD CONSTRAINT spirit_battle_instance_stat_player_id_fkey FOREIGN KEY (player_id) REFERENCES public.player(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: spirit_battle_instance_stat spirit_battle_instance_stat_season_number_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.spirit_battle_instance_stat
    ADD CONSTRAINT spirit_battle_instance_stat_season_number_fkey FOREIGN KEY (season_number) REFERENCES public.game_season(season_number) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: spirit_battle_instance_stat spirit_battle_instance_stat_spirit_definition_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.spirit_battle_instance_stat
    ADD CONSTRAINT spirit_battle_instance_stat_spirit_definition_id_fkey FOREIGN KEY (spirit_definition_id) REFERENCES public.spirit_definition(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict 00pxb5Gfevt6TC4bp8uRUPaZ0UI0PnYzzkYXlS12PuU9G97ymBEkC1LzWjnHVzo
