...
-- CreateEnum
CREATE TYPE "SocialAssistType" AS ENUM ('WATER_FIELD', 'GUARD_FIELD', 'RECOVER_SPIRIT', 'FACTION_TASK_HELP', 'HARVEST_FIELD', 'REVIVE_FIELD');

-- CreateEnum
CREATE TYPE "SocialFeedType" AS ENUM ('FRIEND_WATERED_FIELD', 'FRIEND_GUARDED_FIELD', 'TEAM_CHALLENGE_INVITED', 'TEAM_CHALLENGE_ACCEPTED', 'ENEMY_RAIDED', 'REVENGE_AVAILABLE', 'FACTION_HELP_REQUESTED', 'FRIEND_REQUESTED', 'FRIEND_ACCEPTED', 'FRIEND_REJECTED', 'FRIEND_REVIVED_FIELD', 'FRIEND_DELETED', 'FOLLOWED');
...
CREATE TABLE "player_spirit_slot" (
    ...
    "appearance_frame_id" TEXT,
    "appearance_card_back_id" TEXT,
    "appearance_effect_id" TEXT,
...
-- CreateIndex
CREATE INDEX "admin_operation_audit_log_action_created_at_idx" ON "admin_operation_audit_log"("action" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "admin_operation_audit_log_target_type_target_id_idx" ON "admin_operation_audit_log"("target_type" ASC, "target_id" ASC);

-- CreateIndex
CREATE INDEX "army_training_queue_finish_at_idx" ON "army_training_queue"("finish_at" ASC);

-- CreateIndex
CREATE INDEX "army_training_queue_player_id_status_idx" ON "army_training_queue"("player_id" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "battle_report_owner_player_id_created_at_idx" ON "battle_report"("owner_player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "battle_report_raid_order_id_idx" ON "battle_report"("raid_order_id" ASC);

-- CreateIndex
CREATE INDEX "building_upgrade_log_player_id_created_at_idx" ON "building_upgrade_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "building_upgrade_log_request_idempotency_key_idx" ON "building_upgrade_log"("request_idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "daily_faction_task_faction_id_task_date_idx" ON "daily_faction_task"("faction_id" ASC, "task_date" ASC);

-- CreateIndex
CREATE INDEX "daily_faction_task_player_id_task_date_status_idx" ON "daily_faction_task"("player_id" ASC, "task_date" ASC, "status" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "daily_faction_task_player_id_task_date_task_type_key" ON "daily_faction_task"("player_id" ASC, "task_date" ASC, "task_type" ASC);

-- CreateIndex
CREATE INDEX "essence_transaction_log_essence_type_created_at_idx" ON "essence_transaction_log"("essence_type" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "essence_transaction_log_player_id_created_at_idx" ON "essence_transaction_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "faction_code_key" ON "faction"("code" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "faction_name_key" ON "faction"("name" ASC);

-- CreateIndex
CREATE INDEX "faction_contribution_log_faction_id_created_at_idx" ON "faction_contribution_log"("faction_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "faction_contribution_log_player_id_created_at_idx" ON "faction_contribution_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "faction_member_faction_id_player_id_key" ON "faction_member"("faction_id" ASC, "player_id" ASC);

-- CreateIndex
CREATE INDEX "faction_member_player_id_idx" ON "faction_member"("player_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "faction_season_snapshot_faction_id_season_number_key" ON "faction_season_snapshot"("faction_id" ASC, "season_number" ASC);

-- CreateIndex
CREATE INDEX "faction_season_snapshot_season_number_contribution_score_idx" ON "faction_season_snapshot"("season_number" ASC, "contribution_score" ASC);

-- CreateIndex
CREATE INDEX "field_harvest_log_field_slot_id_idx" ON "field_harvest_log"("field_slot_id" ASC);

-- CreateIndex
CREATE INDEX "field_harvest_log_player_id_created_at_idx" ON "field_harvest_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "field_harvest_log_player_id_seed_id_idx" ON "field_harvest_log"("player_id" ASC, "seed_id" ASC);

-- CreateIndex
CREATE INDEX "game_season_starts_at_ends_at_idx" ON "game_season"("starts_at" ASC, "ends_at" ASC);

-- CreateIndex
CREATE INDEX "idempotency_record_expires_at_idx" ON "idempotency_record"("expires_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "idempotency_record_player_id_endpoint_key_idempotency_key_key" ON "idempotency_record"("player_id" ASC, "endpoint_key" ASC, "idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "idempotency_record_status_updated_at_idx" ON "idempotency_record"("status" ASC, "updated_at" ASC);

-- CreateIndex
CREATE INDEX "player_faction_id_idx" ON "player"("faction_id" ASC);

-- CreateIndex
CREATE INDEX "player_last_login_at_idx" ON "player"("last_login_at" ASC);

-- CreateIndex
CREATE INDEX "assist_pair_date_idx" ON "player_assist_record"("helper_player_id" ASC, "target_player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "player_assist_record_helper_player_id_date_key_assist_type_idx" ON "player_assist_record"("helper_player_id" ASC, "date_key" ASC, "assist_type" ASC);

-- CreateIndex
CREATE INDEX "player_assist_record_target_entity_type_target_entity_id_idx" ON "player_assist_record"("target_entity_type" ASC, "target_entity_id" ASC);

-- CreateIndex
CREATE INDEX "player_assist_record_target_player_id_date_key_assist_type_idx" ON "player_assist_record"("target_player_id" ASC, "date_key" ASC, "assist_type" ASC);

-- CreateIndex
CREATE INDEX "player_auth_identity_player_id_idx" ON "player_auth_identity"("player_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_auth_identity_provider_provider_user_id_key" ON "player_auth_identity"("provider" ASC, "provider_user_id" ASC);

-- CreateIndex
CREATE INDEX "player_daily_task_state_date_key_status_idx" ON "player_daily_task_state"("date_key" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "player_daily_task_state_player_id_date_key_idx" ON "player_daily_task_state"("player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_daily_task_state_player_id_date_key_task_id_key" ON "player_daily_task_state"("player_id" ASC, "date_key" ASC, "task_id" ASC);

-- CreateIndex
CREATE INDEX "player_faction_stipend_state_date_key_claimed_at_idx" ON "player_faction_stipend_state"("date_key" ASC, "claimed_at" ASC);

-- CreateIndex
CREATE INDEX "player_faction_stipend_state_player_id_claimed_at_idx" ON "player_faction_stipend_state"("player_id" ASC, "claimed_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_faction_stipend_state_player_id_date_key_key" ON "player_faction_stipend_state"("player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "player_field_slot_mature_at_idx" ON "player_field_slot"("mature_at" ASC);

-- CreateIndex
CREATE INDEX "player_field_slot_overripe_at_idx" ON "player_field_slot"("overripe_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_field_slot_player_id_slot_index_key" ON "player_field_slot"("player_id" ASC, "slot_index" ASC);

-- CreateIndex
CREATE INDEX "player_field_slot_player_id_status_idx" ON "player_field_slot"("player_id" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "player_field_slot_ready_at_idx" ON "player_field_slot"("ready_at" ASC);

-- CreateIndex
CREATE INDEX "player_invite_relation_invited_player_id_idx" ON "player_invite_relation"("invited_player_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_invite_relation_inviter_player_id_invited_openid_has_key" ON "player_invite_relation"("inviter_player_id" ASC, "invited_openid_hash" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_invite_relation_inviter_player_id_invited_player_id_key" ON "player_invite_relation"("inviter_player_id" ASC, "invited_player_id" ASC);

-- CreateIndex
CREATE INDEX "player_invite_relation_inviter_player_id_status_created_at_idx" ON "player_invite_relation"("inviter_player_id" ASC, "status" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "player_invite_relation_source_campaign_id_idx" ON "player_invite_relation"("source_campaign_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_land_deed_progress_player_id_deed_key_key" ON "player_land_deed_progress"("player_id" ASC, "deed_key" ASC);

-- CreateIndex
CREATE INDEX "player_land_deed_progress_player_id_status_idx" ON "player_land_deed_progress"("player_id" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "player_notification_player_id_claim_status_idx" ON "player_notification"("player_id" ASC, "claim_status" ASC);

-- CreateIndex
CREATE INDEX "player_notification_player_id_deleted_at_created_at_idx" ON "player_notification"("player_id" ASC, "deleted_at" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "player_notification_player_id_read_at_idx" ON "player_notification"("player_id" ASC, "read_at" ASC);

-- CreateIndex
CREATE INDEX "player_notification_system_notification_id_idx" ON "player_notification"("system_notification_id" ASC);

-- CreateIndex
CREATE INDEX "player_plant_research_player_id_idx" ON "player_plant_research"("player_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_plant_research_player_id_seed_definition_id_key" ON "player_plant_research"("player_id" ASC, "seed_definition_id" ASC);

-- CreateIndex
CREATE INDEX "player_raid_daily_state_date_key_idx" ON "player_raid_daily_state"("date_key" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_raid_daily_state_player_id_date_key_key" ON "player_raid_daily_state"("player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "player_raid_pair_daily_state_attacker_player_id_date_key_idx" ON "player_raid_pair_daily_state"("attacker_player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_raid_pair_daily_state_attacker_player_id_defender_pl_key" ON "player_raid_pair_daily_state"("attacker_player_id" ASC, "defender_player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "player_raid_pair_daily_state_defender_player_id_date_key_idx" ON "player_raid_pair_daily_state"("defender_player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_season_achievement_player_id_season_number_achieveme_key" ON "player_season_achievement"("player_id" ASC, "season_number" ASC, "achievement_key" ASC);

-- CreateIndex
CREATE INDEX "player_season_achievement_player_id_season_number_domain_idx" ON "player_season_achievement"("player_id" ASC, "season_number" ASC, "domain" ASC);

-- CreateIndex
CREATE INDEX "player_season_achievement_reward_grant_id_idx" ON "player_season_achievement"("reward_grant_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_season_activity_player_id_season_number_date_key_key" ON "player_season_activity"("player_id" ASC, "season_number" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "player_season_activity_player_id_season_number_idx" ON "player_season_activity"("player_id" ASC, "season_number" ASC);

-- CreateIndex
CREATE INDEX "player_season_activity_season_number_date_key_idx" ON "player_season_activity"("season_number" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "player_season_reward_grant_notification_id_idx" ON "player_season_reward_grant"("notification_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_season_reward_grant_player_id_season_number_reward_t_key" ON "player_season_reward_grant"("player_id" ASC, "season_number" ASC, "reward_type" ASC);

-- CreateIndex
CREATE INDEX "player_season_reward_grant_player_id_status_idx" ON "player_season_reward_grant"("player_id" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "player_season_reward_grant_season_number_reward_type_idx" ON "player_season_reward_grant"("season_number" ASC, "reward_type" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_season_sign_in_player_id_season_number_day_index_key" ON "player_season_sign_in"("player_id" ASC, "season_number" ASC, "day_index" ASC);

-- CreateIndex
CREATE INDEX "player_season_sign_in_player_id_season_number_idx" ON "player_season_sign_in"("player_id" ASC, "season_number" ASC);

-- CreateIndex
CREATE INDEX "player_season_sign_in_season_number_day_index_idx" ON "player_season_sign_in"("season_number" ASC, "day_index" ASC);

-- CreateIndex
CREATE INDEX "player_season_snapshot_faction_id_season_number_idx" ON "player_season_snapshot"("faction_id" ASC, "season_number" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_season_snapshot_player_id_season_number_key" ON "player_season_snapshot"("player_id" ASC, "season_number" ASC);

-- CreateIndex
CREATE INDEX "player_season_snapshot_season_number_contribution_score_idx" ON "player_season_snapshot"("season_number" ASC, "contribution_score" ASC);

-- CreateIndex
CREATE INDEX "player_season_state_current_season_number_idx" ON "player_season_state"("current_season_number" ASC);

-- CreateIndex
CREATE INDEX "player_season_state_last_reset_season_number_idx" ON "player_season_state"("last_reset_season_number" ASC);

-- CreateIndex
CREATE INDEX "player_seed_inventory_player_id_idx" ON "player_seed_inventory"("player_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_seed_inventory_player_id_seed_definition_id_key" ON "player_seed_inventory"("player_id" ASC, "seed_definition_id" ASC);

-- CreateIndex
CREATE INDEX "player_social_feed_actor_player_id_created_at_idx" ON "player_social_feed"("actor_player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "player_social_feed_expires_at_idx" ON "player_social_feed"("expires_at" ASC);

-- CreateIndex
CREATE INDEX "player_social_feed_player_id_feed_type_created_at_idx" ON "player_social_feed"("player_id" ASC, "feed_type" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "player_social_feed_player_id_is_read_created_at_idx" ON "player_social_feed"("player_id" ASC, "is_read" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "player_social_relation_last_interacted_at_idx" ON "player_social_relation"("last_interacted_at" ASC);

-- CreateIndex
CREATE INDEX "player_social_relation_player_id_relation_type_status_idx" ON "player_social_relation"("player_id" ASC, "relation_type" ASC, "status" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_social_relation_player_id_target_player_id_relation__key" ON "player_social_relation"("player_id" ASC, "target_player_id" ASC, "relation_type" ASC);

-- CreateIndex
CREATE INDEX "player_social_relation_target_player_id_relation_type_statu_idx" ON "player_social_relation"("target_player_id" ASC, "relation_type" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "player_spirit_codex_player_id_ready_to_compose_idx" ON "player_spirit_codex"("player_id" ASC, "ready_to_compose" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_spirit_codex_player_id_spirit_definition_id_key" ON "player_spirit_codex"("player_id" ASC, "spirit_definition_id" ASC);

-- CreateIndex
CREATE INDEX "player_spirit_codex_spirit_definition_id_idx" ON "player_spirit_codex"("spirit_definition_id" ASC);

-- CreateIndex
CREATE INDEX "player_spirit_slot_player_id_is_main_idx" ON "player_spirit_slot"("player_id" ASC, "is_main" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_spirit_slot_player_id_slot_index_key" ON "player_spirit_slot"("player_id" ASC, "slot_index" ASC);

-- CreateIndex
CREATE INDEX "player_spirit_slot_spirit_definition_id_idx" ON "player_spirit_slot"("spirit_definition_id" ASC);

-- CreateIndex
CREATE INDEX "player_spirit_trait_spirit_slot_id_idx" ON "player_spirit_trait"("spirit_slot_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "player_spirit_trait_spirit_slot_id_slot_index_key" ON "player_spirit_trait"("spirit_slot_id" ASC, "slot_index" ASC);

-- CreateIndex
CREATE INDEX "player_spirit_trait_trait_code_idx" ON "player_spirit_trait"("trait_code" ASC);

-- CreateIndex
CREATE INDEX "player_wallet_pending_raid_overflow_expires_at_idx" ON "player_wallet"("pending_raid_overflow_expires_at" ASC);

-- CreateIndex
CREATE INDEX "raid_asset_lock_defender_player_id_status_idx" ON "raid_asset_lock"("defender_player_id" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "raid_asset_lock_expires_at_status_idx" ON "raid_asset_lock"("expires_at" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "raid_asset_lock_raid_order_id_idx" ON "raid_asset_lock"("raid_order_id" ASC);

-- CreateIndex
CREATE INDEX "raid_message_template_is_active_sort_order_idx" ON "raid_message_template"("is_active" ASC, "sort_order" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "raid_message_template_template_id_key" ON "raid_message_template"("template_id" ASC);

-- CreateIndex
CREATE INDEX "raid_order_attacker_player_id_status_idx" ON "raid_order"("attacker_player_id" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "raid_order_defender_player_id_status_idx" ON "raid_order"("defender_player_id" ASC, "status" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "raid_order_request_idempotency_key_key" ON "raid_order"("request_idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "raid_order_settle_at_status_idx" ON "raid_order"("settle_at" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "raid_order_message_author_player_id_created_at_idx" ON "raid_order_message"("author_player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "raid_order_message_raid_order_id_key" ON "raid_order_message"("raid_order_id" ASC);

-- CreateIndex
CREATE INDEX "raid_order_message_receiver_player_id_created_at_idx" ON "raid_order_message"("receiver_player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "raid_order_message_template_id_idx" ON "raid_order_message"("template_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "raid_settlement_raid_order_id_key" ON "raid_settlement"("raid_order_id" ASC);

-- CreateIndex
CREATE INDEX "raid_target_pool_owner_player_id_expires_at_idx" ON "raid_target_pool"("owner_player_id" ASC, "expires_at" ASC);

-- CreateIndex
CREATE INDEX "raid_target_pool_owner_player_id_refresh_batch_no_idx" ON "raid_target_pool"("owner_player_id" ASC, "refresh_batch_no" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "raid_target_pool_owner_player_id_target_player_id_slot_inde_key" ON "raid_target_pool"("owner_player_id" ASC, "target_player_id" ASC, "slot_index" ASC, "refresh_batch_no" ASC);

-- CreateIndex
CREATE INDEX "robot_action_log_player_id_created_at_idx" ON "robot_action_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_action_log_robot_key_created_at_idx" ON "robot_action_log"("robot_key" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_action_log_run_id_created_at_idx" ON "robot_action_log"("run_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_action_log_status_created_at_idx" ON "robot_action_log"("status" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_automation_config_enabled_mode_idx" ON "robot_automation_config"("enabled" ASC, "mode" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "robot_automation_config_mode_key" ON "robot_automation_config"("mode" ASC);

-- CreateIndex
CREATE INDEX "robot_automation_job_mode_status_started_at_idx" ON "robot_automation_job"("mode" ASC, "status" ASC, "started_at" ASC);

-- CreateIndex
CREATE INDEX "robot_automation_job_status_started_at_idx" ON "robot_automation_job"("status" ASC, "started_at" ASC);

-- CreateIndex
CREATE INDEX "robot_sim_snapshot_mode_created_at_idx" ON "robot_sim_snapshot"("mode" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_sim_snapshot_player_id_created_at_idx" ON "robot_sim_snapshot"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_sim_snapshot_robot_key_created_at_idx" ON "robot_sim_snapshot"("robot_key" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "robot_sim_snapshot_run_id_idx" ON "robot_sim_snapshot"("run_id" ASC);

-- CreateIndex
CREATE INDEX "robot_test_run_mode_started_at_idx" ON "robot_test_run"("mode" ASC, "started_at" ASC);

-- CreateIndex
CREATE INDEX "robot_test_run_status_started_at_idx" ON "robot_test_run"("status" ASC, "started_at" ASC);

-- CreateIndex
CREATE INDEX "seed_definition_rarity_sort_order_idx" ON "seed_definition"("rarity" ASC, "sort_order" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "seed_definition_seed_id_key" ON "seed_definition"("seed_id" ASC);

-- CreateIndex
CREATE INDEX "share_assist_campaign_expires_at_status_idx" ON "share_assist_campaign"("expires_at" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "share_assist_campaign_owner_player_id_campaign_type_status__idx" ON "share_assist_campaign"("owner_player_id" ASC, "campaign_type" ASC, "status" ASC, "created_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "share_assist_record_campaign_id_helper_device_hash_key" ON "share_assist_record"("campaign_id" ASC, "helper_device_hash" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "share_assist_record_campaign_id_helper_openid_hash_key" ON "share_assist_record"("campaign_id" ASC, "helper_openid_hash" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "share_assist_record_campaign_id_helper_player_id_key" ON "share_assist_record"("campaign_id" ASC, "helper_player_id" ASC);

-- CreateIndex
CREATE INDEX "share_assist_record_campaign_id_status_created_at_idx" ON "share_assist_record"("campaign_id" ASC, "status" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "share_assist_record_helper_player_id_created_at_idx" ON "share_assist_record"("helper_player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "spirit_ad_reward_log_player_id_date_key_idx" ON "spirit_ad_reward_log"("player_id" ASC, "date_key" ASC);

-- CreateIndex
CREATE INDEX "spirit_breakthrough_log_player_id_created_at_idx" ON "spirit_breakthrough_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "spirit_breakthrough_log_request_idempotency_key_idx" ON "spirit_breakthrough_log"("request_idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "spirit_breakthrough_log_spirit_slot_id_idx" ON "spirit_breakthrough_log"("spirit_slot_id" ASC);

-- CreateIndex
CREATE INDEX "spirit_definition_rarity_sort_order_idx" ON "spirit_definition"("rarity" ASC, "sort_order" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "spirit_definition_spirit_id_key" ON "spirit_definition"("spirit_id" ASC);

-- CreateIndex
CREATE INDEX "spirit_feed_log_player_id_created_at_idx" ON "spirit_feed_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "spirit_feed_log_request_idempotency_key_idx" ON "spirit_feed_log"("request_idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "spirit_feed_log_spirit_slot_id_idx" ON "spirit_feed_log"("spirit_slot_id" ASC);

-- CreateIndex
CREATE INDEX "spirit_shop_purchase_log_player_id_item_id_period_key_idx" ON "spirit_shop_purchase_log"("player_id" ASC, "item_id" ASC, "period_key" ASC);

-- CreateIndex
CREATE INDEX "spirit_trait_roll_log_player_id_created_at_idx" ON "spirit_trait_roll_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "spirit_trait_roll_log_request_idempotency_key_idx" ON "spirit_trait_roll_log"("request_idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "spirit_trait_roll_log_spirit_slot_id_idx" ON "spirit_trait_roll_log"("spirit_slot_id" ASC);

-- CreateIndex
CREATE INDEX "system_notification_audience_created_at_idx" ON "system_notification"("audience" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "system_notification_category_created_at_idx" ON "system_notification"("category" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "system_notification_revoked_at_idx" ON "system_notification"("revoked_at" ASC);

-- CreateIndex
CREATE INDEX "task_config_override_task_group_is_enabled_idx" ON "task_config_override"("task_group" ASC, "is_enabled" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "task_config_override_task_group_task_id_key" ON "task_config_override"("task_group" ASC, "task_id" ASC);

-- CreateIndex
CREATE INDEX "task_reward_log_player_id_created_at_idx" ON "task_reward_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "task_reward_log_request_idempotency_key_idx" ON "task_reward_log"("request_idempotency_key" ASC);

-- CreateIndex
CREATE INDEX "team_challenge_ally_player_id_status_created_at_idx" ON "team_challenge"("ally_player_id" ASC, "status" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "team_challenge_expires_at_status_idx" ON "team_challenge"("expires_at" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "team_challenge_initiator_player_id_status_created_at_idx" ON "team_challenge"("initiator_player_id" ASC, "status" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "team_challenge_target_player_id_created_at_idx" ON "team_challenge"("target_player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "wallet_change_log_change_type_created_at_idx" ON "wallet_change_log"("change_type" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "wallet_change_log_player_id_created_at_idx" ON "wallet_change_log"("player_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "wallet_change_log_request_idempotency_key_idx" ON "wallet_change_log"("request_idempotency_key" ASC);
